...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.254.5/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.254.7/31 | - | - |
...
| Ethernet5 | DC1-L2LEAF1A_Ethernet2 | *1500 | *switched | *trunk | *111-113,120-121,130-131 | - | - | - | 5 | active |
...
| Tenant_A_OP_Zone | 192.168.255.4:10 | both 10:10 | learned | 111-113 |
...
router bgp 65101
   ...
   neighbor 172.31.254.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.254.6 peer group IPv4-UNDERLAY-PEERS
