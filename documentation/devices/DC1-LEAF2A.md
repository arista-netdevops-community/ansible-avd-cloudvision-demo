...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet3 | 1500 | routed | access | - | - | - | 172.31.254.9/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet3 | 1500 | routed | access | - | - | - | 172.31.254.11/31 | - | - |
...
| Ethernet5 | DC1-L2LEAF2A_Ethernet1 | *1500 | *switched | *trunk | *111-113,120-121,130-131 | - | - | - | 5 | active |
...
| Tenant_A_OP_Zone | 192.168.255.5:10 | both 10:10 | learned | 111-113 |
...
router bgp 65102
   ...
   neighbor 172.31.254.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.254.10 peer group IPv4-UNDERLAY-PEERS
