...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.16.47.31/24 | 172.16.47.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1 | Vlan4094 | 10.255.252.1 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_DC1_LEAF-1B_Ethernet5 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1_SPINE-1_Ethernet1 | routed | - | 172.31.255.1/31 | default | 9000 | false | - | - |
| Ethernet2 | P2P_LINK_TO_DC1_SPINE-2_Ethernet1 | routed | - | 172.31.255.3/31 | default | 9000 | false | - | - |
| Ethernet3 | P2P_LINK_TO_DC1_SPINE-3_Ethernet1 | routed | - | 172.31.255.5/31 | default | 9000 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1_SPINE-4_Ethernet1 | routed | - | 172.31.255.7/31 | default | 9000 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1_SPINE-1_Ethernet1
   no shutdown
   mtu 9000
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1_SPINE-2_Ethernet1
   no shutdown
   mtu 9000
   no switchport
...
!
interface Ethernet3
   description P2P_LINK_TO_DC1_SPINE-3_Ethernet1
   no shutdown
   mtu 9000
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_DC1_SPINE-4_Ethernet1
   no shutdown
   mtu 9000
   no switchport
...
!
interface Ethernet5
   description MLAG_PEER_DC1_LEAF-1B_Ethernet5
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_DC1_LEAF-1B_Po5 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel5
   description MLAG_PEER_DC1_LEAF-1B_Po5
   no shutdown
   switchport
...
router bgp 65101
   ...
   neighbor 10.255.251.1 description DC1_LEAF-1B
